...
void _testBaseWindow() {
  ...
  testO("color and pos test", () async {
    ...
    expect(mWindow.getMiddle(), Point<int>(640, 360), reason: "middle a bit shifted");
...
void _testInput() {
  testO("focus test (only working with Command Prompt) and interact tests(moving your mouse around / using "
    ...
    expect(mWindow.windowMousePos, Point<int>(80, 640), reason: "first move mouse should match");
    ...
    expect(mWindow.windowMousePos, Point<int>(1130, 50), reason: "second move mouse should match");
    await InputManager.leftClick();
    ...
    final String afterTestData = "_after_test_data_시험";

...
mixin SimpleChangeStream<T> {
  ...
  SimpleChangeStream<T> get simpleChangeStream => this;
  ...
  StreamSubscription<T> listenToEvents(void Function(T message) callbackFunction) {
